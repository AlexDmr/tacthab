...
function ControlPoint() {
  ...
  this.server.bind(SSDP_PORT, function () {
	...
	this.server.setMulticastTTL(8);
	console.log('UDP4 server addMembership ' + BROADCAST_ADDR);
	setTimeout( function() {return;
					 console.log('try again'); 
					 self.server = dgram.createSocket('udp4');
					 self.server.on('message', function(msg, rinfo) {self.onRequestMessage(msg, rinfo);});
					 self.server.bind(SSDP_PORT, function () {
						 self.server.addMembership(BROADCAST_ADDR);
						 console.log("\tsearch for upnp:rootdevice");
...
ControlPoint.prototype.search = function(st) {
  ...
  client.bind(function() {
	  ...
	  debug('address: ' + address.address + ' and port: ' + address.port);
